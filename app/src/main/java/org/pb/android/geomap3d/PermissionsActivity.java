...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private void startMainActivityClean() {
        MainActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK).extras(getIntent()).start();
        finishAffinity();
    }
}
